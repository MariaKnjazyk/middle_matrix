...
router.route('/')
    ...
    .post(celebrate(visitValidator.create), authMiddleware.validateToken(),  userMiddleware.checkUserAccess([USER_ROLES.DOCTOR, USER_ROLES.HEAD_DOCTOR]), visitMiddleware.isTimeSlotNotFree, visitController.)
